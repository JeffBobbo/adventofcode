...
sub day2
{
  ...
  foreach my $present (@data)
  {
    ...
    $paperOrder += $w + $h + $l + $shortest;
  }
  print 'Paper needed to wrap all the presents ' . $paperOrder . "\n";
  }
  ...
  foreach my $present (@data)
  {
    ...
    my $ribbon = $d[0]*2 + $d[1]*2;
    $ribbon += $d[0]*$d[1]*$d[2];
    $length += $ribbon;
  }
  print 'Amount of ribbon needed is ' . $length . "\n";
  }
}
